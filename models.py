...
class models:
	...
	def CNN2D_type1(traindata, trainlabels, testdata, testlabels):
		model = Sequential()
	...
	def CNN2D_type2(traindata, trainlabels, testdata, testlabels):
		model = Sequential()
		model.add(Conv2D(64, kernel_size=(15, 15), activation='relu', input_shape=(28,28,1)))
		model.add(MaxPooling2D(pool_size=(2, 2)))
		model.add(Dropout(0.2))
	...
	def CNN2D_type3(traindata, trainlabels, testdata, testlabels):
		model = Sequential()
		model.add(Conv2D(256, kernel_size=(15, 15), activation='relu', input_shape=(28,28,1)))
		model.add(MaxPooling2D(pool_size=(2, 2)))
		model.add(Dropout(0.2))
	...
	def MLPNN_type2(traindata, trainlabels, testdata, testlabels):
		model = Sequential()
		model.add(Dense(512, activation='relu', input_shape=(784,)))
		model.add(Dropout(0.2))
		model.add(Dense(10, activation='softmax'))
	...
	def MLPNN_type3(traindata, trainlabels, testdata, testlabels):
		model = Sequential()
		model.add(Dense(64, activation='relu', input_shape=(784,)))
		model.add(Dropout(0.2))
		model.add(Dense(10, activation='softmax'))
	...
	def MLPNN_type4(traindata, trainlabels, testdata, testlabels):
		model = Sequential()
		model.add(Dense(512, activation='relu', input_shape=(784,)))
		model.add(Dropout(0.2))
		model.add(Dense(512, activation='relu'))
